...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2014 a las 22:44:29
...
(46, 1, 'Inicio sesión el usuario o_kab_admin', 'Login', 'o_kab_admin', '2014-10-03 00:04:09'),
(47, 1, 'Inicio sesión el usuario o_kab_admin', 'Login', 'o_kab_admin', '2014-10-03 00:24:40'),
(48, 1, 'Inicio sesión el usuario o_kab_admin', 'Login', 'o_kab_admin', '2014-10-04 02:57:37'),
(49, 1, 'Cerró sesión el usuario o_kab_admin', 'Login', 'o_kab_admin', '2014-10-04 03:09:10'),
(50, 0, 'Cerró sesión el usuario ', 'Login', '0', '2014-10-04 03:09:10'),
(51, 1, 'Inicio sesión el usuario o_kab_admin', 'Login', 'o_kab_admin', '2014-10-04 03:09:57');
...
(3, '2014-10-03', 15000, 0, 'MOVE-0009', '2014-10-04 04:38:10'),
(4, '2014-10-07', 120000, 0, 'MOVENT001', '2014-10-04 04:42:00'),
(5, '2014-10-02', 500000, 0, 'DEP-00132', '2014-10-04 04:43:22'),
(6, '2014-10-03', 500000, 0, 'DEP-00132', '2014-10-04 04:48:36');
...
(3, 1, 1, 1, 15000, 2, '2014-10-03', 'PAG-00004', 'archivos/descarga/41a4bff2a441be920beb381cda7ebad7af04d99a690', '2014-10-04 04:25:35');
...
(7, 2, 1, 5, '2014-10-03', 'salida_pago', '2014-10-04 04:25:35'),
(8, 2, 1, 6, '2014-10-03', 'salida', '2014-10-04 04:36:49'),
(9, 2, 1, 7, '2014-10-03', 'mov_int', '2014-10-04 04:38:10'),
(10, 2, 1, 3, '2014-10-03', 'deposito', '2014-10-04 04:38:10'),
(11, 2, 1, 8, '2014-10-07', 'mov_int', '2014-10-04 04:42:00'),
(12, 1, 2, 4, '2014-10-07', 'deposito', '2014-10-04 04:42:00'),
(13, 1, 1, 5, '2014-10-02', 'deposito', '2014-10-04 04:43:23'),
(14, 1, 2, 6, '2014-10-03', 'deposito', '2014-10-04 04:48:36');
...
(2, 2, 1, 1, 2, 15000, '2014-10-03', 'MOVE-0009', 'MOVS-0008', NULL),
(3, 2, 1, 1, 2, 120000, '2014-10-07', 'MOVENT001', 'MOVSAL001', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ad_repo_archivos`
--

CREATE TABLE IF NOT EXISTS `ad_repo_archivos` (
  `id_repo` int(11) NOT NULL AUTO_INCREMENT,
  `clave_repo` varchar(100) DEFAULT NULL,
  `ruta_repo` varchar(150) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `ad_repo_archivos`
--

INSERT INTO `ad_repo_archivos` (`id_repo`, `clave_repo`, `ruta_repo`, `nombre_archivo`, `mime`, `bytes`, `fecha`) VALUES
(1, 'f29bd82b7bcd6b329c69e5ab694a526d6dc6d139825', 'files/comprobantes_pago/', 'bebemusjpg', 'image/jpeg', 81876, '2014-10-03 00:26:43'),
(2, '41a4bff2a441be920beb381cda7ebad7af04d99a114', 'files/comprobantes_pago/', 'comprobante_domiciliojpg', 'image/jpeg', 10022, '2014-10-04 03:15:47'),
(3, '41a4bff2a441be920beb381cda7ebad7af04d99a690', 'files/comprobantes_pago/', 'comprobante_domiciliojpg', 'image/jpeg', 10022, '2014-10-04 04:25:23');
...
(5, '2014-10-03', 15000, 'PAG-00004', '2014-10-04 04:25:35'),
(6, '2014-10-03', 476598.88, 'SAL-00005', '2014-10-04 04:36:49'),
(7, '2014-10-03', 15000, 'MOVS-0008', '2014-10-04 04:38:10'),
(8, '2014-10-07', 120000, 'MOVSAL001', '2014-10-04 04:42:00');
...
(1, 1, 'o_kab_admin', '82266eb2f210a93224ce8ff0f59592da5b9e6a6f', 1, 1, '2014-10-03 22:09:57', '2014-10-04 03:09:57'),
