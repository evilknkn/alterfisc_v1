    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
                ...
                <?php endif;?>
                <a href="<?=base_url('cuentas/gastos_camion/insert_deposito/'.$id_empresa.'/'.$id_banco)?>" style="margin-left:15px" class="btn btn-primary"> <i class="fa fa-plus"></i> Agregar depósito</a>
                <a href="<?=base_url('cuentas/salida/insertar_salida_gasto_camion/'.$id_empresa.'/'.$id_banco)?>" style="margin-left:15px" class="btn btn-primary"> <i class="fa fa-plus"></i> Agregar Salida</a>
                        ...
                        <?php if($type_mov == 'deposito' or $type_mov == 'deposito_interno' )
                            ...
                            <?php }else{
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?=base_url('cuentas/salida/editar_salida_gasto_camion/'.$id_empresa.'/'.$id_banco.'/'.$salida->id_salida)?>"  data-toggle-title="Haga clic aquí para borrar depósito">
                                                <i class="fa fa-edit fa-lg"></i>
                                            </a>
                                        </td>
                                       <!--  <td class="text-center">
...
<?=$this->load->view('/admin/cuentas/gastos_camion/consulta_saldo')?>